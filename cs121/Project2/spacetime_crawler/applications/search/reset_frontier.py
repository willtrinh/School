...
from datamodel.search.Wtrinh2Antl2Huyqn6_datamodel import Wtrinh2Antl2Huyqn6Link
...
@Deleter(Wtrinh2Antl2Huyqn6Link)
@Getter(Wtrinh2Antl2Huyqn6Link)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Wtrinh2Antl2Huyqn6Link)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Wtrinh2Antl2Huyqn6Link, l)
...
class Simulation(object):
    ...
    def __init__(self, address, port):
        ...
        objectless_connector = ObjectlessSpacetimeConnection(
            "ResetFrontier_Wtrinh2Antl2Huyqn6".format(CrawlerFrame.app_id),
